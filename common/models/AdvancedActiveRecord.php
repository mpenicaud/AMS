...
class AdvancedActiveRecord extends ActiveRecord
{
        /**
     * @inheritdoc
     */
...
//    }
	...
	public function attributes()
	{
            if (Yii::$app->params['docAttributeDetection']) {
            ...
            return  yii\helpers\ArrayHelper::merge(array_keys($this->attributes),array('_id')
